use super::honk_verifier_circuits::{
    ...
    run_GRUMPKIN_HONK_SUMCHECK_SIZE_12_PUB_22_circuit,
};
...
mod UltraStarknetHonkVerifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_HONK_SUMCHECK_SIZE_12_PUB_22_circuit, vk,
    };
    ...
    impl IUltraStarknetHonkVerifier of super::IUltraStarknetHonkVerifier<ContractState> {
        fn verify_ultra_starknet_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_HONK_SUMCHECK_SIZE_12_PUB_22_circuit(
